    ...
    >
      ...
      <div class="dialog-content">
                ...
                <div class="m-flex-1">
                  ...
                  <div class="m-control">
                    <input
                      ...
                      class="input-required"
                      type="text"
                      v-model="employeeInfo.IdentityPlace"
                    />
                  </div>
                </div>
        ...
        <div class="dialog-footer">
          ...
          <button id="btnSave" class="m-btn m-btn-default" @click="addData">
...
export default {
  ...
  methods: {
    ...
    addData() {
      if (this.employeeInfo.EmployeeId == null) {
        const response = axios
          .post("http://api.manhnv.net/api/employees", this.employeeInfo)
          .catch((e) => console.log(e));
        console.log(response);
        // console.log("thuc hien add")
      } else {
        const response = axios
          .put("http://api.manhnv.net/api/employees", this.employeeInfo)
          .catch((e) => console.log(e));
        console.log(response);
      }
  ...
  updated() {
    this.employeeInfo = this.dataEmployee;
  },
  data() {
    return {
      dialog: false,
